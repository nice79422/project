...
<script>
	...
	function zipcodeFunc(){
		features = "width=650px; height=390px; titlebar=no; status=no";
		window.open("${pageContext.request.contextPath}/base/zipCodeForm.html","우편번호검색",features);
	}
