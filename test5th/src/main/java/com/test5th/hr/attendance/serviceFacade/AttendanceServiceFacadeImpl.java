package com.test5th.hr.attendance.serviceFacade;
...
import com.test5th.hr.attendance.applicationService.AttdReportAppService;
import com.test5th.hr.attendance.applicationService.DailyAttdAppService;
import com.test5th.hr.attendance.applicationService.DailyAttdRestAppService;
import com.test5th.hr.attendance.applicationService.DayAnnualAppService;
...
public class AttendanceServiceFacadeImpl implements AttendanceServiceFacade{
	...
	public List<DayAnnualBean> findAnnualMgt(HashMap<String,String> map) {
		return dayAnnualAppService.findAnnualMgt(map);
	}
	...
	public List<OverNightReportBean> findOverNightReport(HashMap<String, String> map){
		return attdReportAppService.findOverNightReport(map);
	} 
	/*연장심야 일괄 신청*/
