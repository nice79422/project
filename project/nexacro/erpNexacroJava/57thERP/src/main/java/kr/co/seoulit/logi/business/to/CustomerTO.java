...
public class CustomerTO extends BaseTO {
	...
	String customerCode, workplaceCode, customerName, customerType, customerCeo, businessLicenseNumber,
			socialSecurityNumber, customerBusinessConditions, customerBusinessItems, customerZipCode,
			customerBasicAddress, customerDetailAddress, customerTelNumber, customerFaxNumber, customerNote;
