...
import com.test4th.hr.attendance.dao.DailyAttdRestDAO;
...
public class DailyAttdRestAppServiceImpl implements DailyAttdRestAppService {
	...
	public void setDailyAttdRestDAO(DailyAttdRestDAO dailyAttdRestDAO) {
		this.dailyAttdRestDAO = dailyAttdRestDAO;
	}
